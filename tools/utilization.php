<?php
 ...
 $res = mysqli_query($db, 'select * from booking_locations join bookings b on booking_locations.booking_id = b.id join users u on b.user_id = u.id order by booking_locations.id asc');
 $map = [];
