...
module.exports = class OrderService extends Service {
  ...
  static *createTimeOrder(booking, user) {
    ...
    try {
      ...
      yield notify.notifyAdmins(`:moneybag: Successfully charged ${ user.name() } for ${ minutesOver} minutes extra driving time | ${ apiConfig.uri }/bookings/${ booking.id }`, [ 'slack' ], { channel : '#rental-alerts' });
