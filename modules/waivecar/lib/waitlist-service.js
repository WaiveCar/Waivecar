...
module.exports = {
  ...
  *letInByRecord(recordList, _user, opts) {
    ...
    let introMap = {
      ...
      waivework: `Welcome to the Waivework program. If you have received this email, it means you have been approved! If you choose to move forward with WaiveWork your payment will be $${opts.perWeek} a week. If you have any questions, please don't hesitate to email Frank by clicking <a href="mailto:frank@waive.car">here</a>. When scheduling a pickup appointment, please keep in mind that our billing dates are on the 1st, 8th, 15th and 22nd of each month. If you pick up a car on a different date, your initial payment will be of a prorated amount based on the number of days left until the following billing day. Your initial payment will be due when you pick up the car.`,
  ...
  *sendWaiveWorkEmail(opts) {
    ...
    context.intro = `Welcome to the Waivework program. If you have received this email, it means you have been approved! If you choose to move forward with WaiveWork your payment will be $${opts.perWeek} a week. If you have any questions, please don't hesitate to email Frank by clicking <a href="mailto:frank@waive.car">here</a>. When scheduling a pickup appointment, please keep in mind that our billing dates are on the 1st, 8th, 15th and 22nd of each month. If you pick up a car on a different date, your initial payment will be of a prorated amount based on the number of days left until the following billing day. Your initial payment will be due when you pick up the car.`;
    try {
      emailOpts = {
        to       : opts.email,
        from     : config.email.sender,
