...
module.exports = {
  ...
  *letInByRecord(recordList, _user, opts) {
    ...
    let introMap = {
      ...
      waivework: `Welcome to the Waivework program. If you have received this email, it means you have been approved! If you choose to move forward with WaiveWork your payment will be $${opts.perWeek} a week. If you have any questions, please email Frank by clicking <a href="mailto:frank@waive.car">here</a>.`,
  ...
  *sendWaiveWorkEmail(opts) {
    ...
    context.intro = `Welcome to the Waivework program. If you have received this email, it means you have been approved! If you choose to move forward with WaiveWork your payment will be $${opts.perWeek} a week. If you have any questions, please email Frank by clicking <a href="mailto:frank@waive.car">here</a>.`;
    try {
      emailOpts = {
        to       : opts.email,
        from     : config.email.sender,
