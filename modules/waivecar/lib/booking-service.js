...
module.exports = class BookingService extends Service {
  ...
  static *end(id, _user, query, payload) {
    ...
    */
    ...
    if(deltas.charge > 0) {
      ...
      let miles = Math.floor((deltas.charge / 100) * car.getRange('LOW') * 0.96);
  ...
  static *_complete(id, _user, query, payload) {
    ...
    yield notify.sendTextMessage(user, `You're all done! Reply "rebook" to rebook now for $${rebookCost}. Left a thing behind? Reply "unlock" to get it in the next 5min.`);
