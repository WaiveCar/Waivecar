...
module.exports = class BookingService extends Service {
  ...
  static *create(data, _user) {
    ...
    let msg = `${car.license} is yours! If you're having difficulties starting the ride with the app, text 'start ride' to this number when you're next to the WaiveCar. ${currentParking ? `It is WaiveParked with the notes: "${currentParking.notes}". ` : ''}${inject}${timeToCar} minutes to get to it. Thanks!`;
    if (isLevel) {
