...
scheduler.process('booking-auto-cancel', function *(job) {
  ...
  if (booking.status === 'reserved') {
    ...
    yield notify.notifyAdmins(`The booking with ${ car.license || car.id } was automatically cancelled, after their 15 minute timer expired.`, [ 'slack' ], { channel : '#reservations' });
