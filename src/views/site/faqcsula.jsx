    ...
    return (
      <div className='container'>
        <div className='row'>
          ...
          <h3 id="do-you-guys-cover-the-the-refueling">Do you guys cover the the refueling?</h3>
          <p>Yes, but only when using the campus refueling station!</p>
          ...
          <li><strong>Vehicle Recovery </strong> $300 minimum</li>
