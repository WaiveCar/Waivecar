    ...
    return (
      <div className='container'>
        <div className='row'>
          ...
          <p>Our cars are available 24/7 however the HQ is open from 9am-10pm and the customer service line is open from 9am-midnight. If you need assistance at other hours, simply send us an email at support@waive.car and we will reach you at our earliest convenience.</p>
          ...
          <p>Nope! Follow the rules above. If the car is under 25% charged (20 miles), simply return it at the HQ!</p>
          <h3 id="fees">Fees</h3>
          <p>There are some modest fees in order to keep our fleet bright and shiny.</p>
          <ul>
          <li><strong>Ending with under 20% charge and not brought back to WaiveCar's lot</strong> $20</li>
