    ...
    return (
      <div className='container'>
        <div className='row'>
          ...
          <p>Right now our cars are dispersed between Santa Monica and Hollywood, check our map in our app for more details. In the near future, you will be able to pick them up anywhere in LA and other major cities!</p>
          <h3 id="how-long-do-i-have-to-get-to-a-waivecar">How long do I have to get to a WaiveCar?</h3>
          <p>You have 15 minutes to get to a WaiveCar before the reservation times out. You may purchase an additional 10 minutes for a $1 fee.  If you are 55 or over, you automatically get WaiveAid. WaiveAid allows you 25 minutes to get to your WaiveCar, for free, every time. You can still purchase an additional 10 minutes more for $1, totaling 35 minutes. If you are under 55 and need assistance, such as having a child in stroller or a handicap placard, please contact us</p>
          ...
          <p>You can drive up to 25 miles outside of any of our parking borders, which includes most of LA. You will get a text message alert when you have passed the boundaries! Along with being free the first 2 hours, a single WaiveCar can be rented for up to 12 hours at a time.</p>
