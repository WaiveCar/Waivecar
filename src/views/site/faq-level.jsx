...
module.exports = class Faq-bk extends Component {
  render() {
    return (
      <div className='container'>
        <div className='row'>
          ...
          <p>Yep! However, if you have a Pennsylvania license, please email us at support@waive.car as Pennsylvania requires a separate background check form to be filled out.</p>
          <h3 id="can-i-use-an-out-of-country-drivers-license">Can I use an out of country drivers license?</h3>
          <p>Yep! However you will need to contact your DMV and obtain a driving record to email to us at support@waive.car</p>
          ...
          <p>It's very quick! Should only take about 10 minutes for the signup and the background check to complete. If the background check seems to be taking longer, please give us a call at 855-WAIVE55</p>
          <h2 id="booking-cars">Booking Cars</h2>
          <h3 id="what-are-waivecars-hours">What are WaiveCar's hours?</h3>
          <p>Our cars are available 24/7 and the customer service line is open from 9am-midnight, California time. If you need assistance at other hours, simply send us an email at support@waive.car and we will reach you at our earliest convenience.</p>
          ...
          <p>All WaiveCars must be returned to the 24 hour parking lot at 34 N 7th Street. You won't need to pay anything at the lot, so don't worry - the attendants will help you.</p>
          <h3 id="how-do-i-end-my-ride">How do I end my ride?</h3>
          <p>First make sure that you have returned the vehicle to the parking lot. Turn off the car, put the key back on the sensor in the glovebox, grab your belongings, and exit the car. Select &quot;End Ride&quot; from the app and input the appropriate information. If you haven't received a confirmation text please call us at 855-WAIVE55!</p>
          ...
          <ul>
          <li><strong>Ending with under 20 miles charge and not brought back to the lot</strong> $20</li>
          ...
          <ul>
          <li><strong>Vehicle Recovery</strong> Miscellaneous Recovery Costs</li>
