          ...
          <form className="bento-form-static" role="form" onSubmit={ this.submit } style={{ marginTop : 20 }}>
            <div className="form-group row">
              <FormInput className="col-md-4 bento-form-input">
                ...
                <input type="text" name="number" className="form-control" defaultValue={ license.number } disabled={ !license.provided && !isAdmin} required />
              </FormInput>
              <FormInput className="col-md-4 bento-form-input">
                <label>State</label>
                <input type="text" name="state" className="form-control" defaultValue={ license.state } disabled={ !license.provided && !isAdmin} required />
              </FormInput>
              <FormInput className="col-md-4 bento-form-input">
                <label>Status</label>
            ...
            <div className="form-group row">
              <FormInput className="col-md-6 bento-form-input">
                ...
                <input type="text" name="street1" className="form-control" defaultValue={ license.street1 } disabled={ !license.provided && !isAdmin} required />
              </FormInput>
              <FormInput className="col-md-6 bento-form-input">
                <label>Address Line 2</label>
                <input type="text" name="street2" className="form-control" defaultValue={ license.street2 } disabled={ !license.provided && !isAdmin} />
              </FormInput>
            </div>
            <div className="form-group row">
              <FormInput className="col-md-4 bento-form-input">
                <label>City</label>
                <input type="text" name="city" className="form-control" defaultValue={ license.city } disabled={ !license.provided && !isAdmin} />
              </FormInput>
              <FormInput className="col-md-4 bento-form-input">
                <label>Zip</label>
                <input type="text" name="zip" className="form-control" defaultValue={ license.zip } disabled={ !license.provided && !isAdmin} />
              </FormInput>
            </div>
            <div className="form-group row">
              <FormInput className="col-md-4 bento-form-input">
                <label>First Name</label>
                <input type="text" name="firstName" className="form-control" defaultValue={ license.firstName } disabled={ !license.provided && !isAdmin} required />
              </FormInput>
              <FormInput className="col-md-4 bento-form-input">
                <label>Middle Name (Optional)</label>
                <input type="text" name="middleName" className="form-control" defaultValue={ license.middleName } disabled={ !license.provided && !isAdmin} />
              </FormInput>
              <FormInput className="col-md-4 bento-form-input">
                <label>Last Name</label>
                <input type="text" name="lastName" className="form-control" defaultValue={ license.lastName } disabled={ !license.provided && !isAdmin} required />
              </FormInput>
            </div>
            <div className="form-group row">
              <FormInput className="col-md-4 bento-form-input">
