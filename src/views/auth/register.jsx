    ...
    return (
      <div className="login">
        ...
        <div className="actions">
          ...
          <a className="r-btn btn-facebook" href="https://www.facebook.com/dialog/oauth?client_id=783941098370564&redirect_uri=http://local.io:8080/auth/facebook&state=register">
